...
function LightRays({
  ...
  useEffect(() => {
    if (!isVisible || !containerRef.current || reducedMotion) return undefined
...
void main() {
  ...
  gl_FragColor = color;
      ...
      const updatePlacement = () => {
        ...
        const width = clientWidth * currentRenderer.dpr
        const height = clientHeight * currentRenderer.dpr
      ...
      const renderLoop = (time) => {
        ...
        try {
          ...
          animationIdRef.current = window.requestAnimationFrame(renderLoop)
        } catch (error) {
