...
const ProfileCardComponent = ({
  avatarUrl = '/assets/demo/mansur.jpg',
              ...
              >
                <img
                  ...
                  style={{
                    ...
                    transform: 'scale(1.06) translate3d(calc((var(--pointer-from-left) - 0.5) * -10px), calc((var(--pointer-from-top) - 0.5) * -6px), 0)',
                    borderRadius: cardRadius,
                  }}
                  onError={(e) => {
